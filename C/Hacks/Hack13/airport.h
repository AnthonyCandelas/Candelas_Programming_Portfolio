 ...
 * Date: 08Dec2025
 * Lab/Task: Hack13 - Airport sorting and searching
 *
 * Description:
 * Provides an Airport structure and utility functions for
 * creating airports, formatting them, computing distances,
 * and generating sorted/searched reports.
 *
 * Notes:
 * - Functions that return allocated memory document that the
 *   caller is responsible for calling free() on the returned pointer.
 * - Comparator functions follow qsort/bsearch conventions.
 */

#ifndef HACK13_AIRPORT_H
#define HACK13_AIRPORT_H
