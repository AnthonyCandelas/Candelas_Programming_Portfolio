...
2.  Read Chapters 12 and 25 of the course textbook (link removed).
...
Clone the project code for this lab from GitHub using the appropriate course or instructor-provided URL.
