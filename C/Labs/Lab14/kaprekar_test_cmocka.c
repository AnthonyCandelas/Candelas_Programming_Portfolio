 ...
 *
 * Description:
 * cmocka test suite for Kaprekar number function verification.
 */
#include<stdlib.h>
#include<stdio.h>
#include<stdarg.h>
...
int main(int argc, char **argv) {
  ...
  const struct CMUnitTest tests[] = {
    ...
    cmocka_unit_test_prestate(testValue, &testC),
    cmocka_unit_test_prestate(testValue, &testD),
    cmocka_unit_test_prestate(testValue, &testE),
    cmocka_unit_test_prestate(testValue, &testF),
    cmocka_unit_test_prestate(testValue, &testG),
    cmocka_unit_test_prestate(testValue, &testH),
    cmocka_unit_test_prestate(testValue, &testI),
    cmocka_unit_test_prestate(testValue, &testJ),
    cmocka_unit_test_prestate(testValue, &testK),
    cmocka_unit_test_prestate(testValue, &testL),
    cmocka_unit_test_prestate(testValue, &testM),
    cmocka_unit_test_prestate(testValue, &testN),
    cmocka_unit_test_prestate(testValue, &testO),
    cmocka_unit_test_prestate(testValue, &testP),
